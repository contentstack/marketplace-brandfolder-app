const localeTexts = {
  ConfigFields: {
    isExtension: {
      ...
      warning_note:
        "Legacy settings allowlet you to use the Brandfolder app with Extension support to retrieve asset JSON data, similar to the Brandfolder Extension. If you are using the latest Brandfolder app, you can skip these settings.<br/><b>Note:</b> Toggling between aApp and eExtension settings may result in data variation",
      info_note:
