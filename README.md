...
The repo source folder will be referred to as APP_DIRECTORY from now on.
...
> Note :-
>
> - When hosting your app locally, you can't include a JSON RTE within the same app on the Developer Hub because it uses a different port. To work around this, after completion of the UI of the Configscreen, Customfield and Selectorpage, change the `App URL` in your app and set it to "https://localhost:1268" and add the JSON RTE with the path "/[your app name].js."
...
We have used below boilerplate for developing this DAM app.
